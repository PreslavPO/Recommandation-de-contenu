...
from resources.user import SignUp, Logout, Login, CheckSession, UserRating, UserRatingMovies, UserRecommendation
...
api.add_resource(UserRatingMovies, "/user/rating") # TODO : In front, add sort and page
